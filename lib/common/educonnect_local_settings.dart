...
class MawjoodLocalSettings {
  ...
  static Future<bool> isFirstTime() async {
    ...
    Madpoly.print('isFirstTime = $value',
        developer: 'ziad', tag: 'OnboardingManager', isLog: true);
    return value;
  }
  ...
  static Future<int> getCurrentLang() async {
    ...
    Madpoly.print('(LanguageSettings=> get )language_index = $value',
        developer: 'ziad', tag: 'OnboardingManager', isLog: true);
    return value;
  }
  ...
  static Future<void> saveCurrentLang(int lang) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    Madpoly.print('(LanguageSettings=> save )setLang $lang',
        developer: 'ziad', tag: 'OnboardingManager', isLog: true);
